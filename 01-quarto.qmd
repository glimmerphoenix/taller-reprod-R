...
- **Programming engine**: R, Python, Julia (lenguajes de programación que se pueden ejecutar
en un entorno [REPL](https://en.wikipedia.org/wiki/Read%E2%80%93eval%E2%80%93print_loop)).
